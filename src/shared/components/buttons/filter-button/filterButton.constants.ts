...
export const filterButtonVariants = cva(
  'text-md inline-flex h-9.25 cursor-pointer items-center justify-center gap-1 rounded-full px-[1em] transition-all duration-200 md:h-11 md:gap-1.5 md:text-lg',
  {
    variants: {
      state: {
        normal:
